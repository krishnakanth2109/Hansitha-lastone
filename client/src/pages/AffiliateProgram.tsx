        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="mb-12 bg-white/80 p-8 rounded-xl shadow-lg backdrop-blur-sm">
            ...
            <div className="space-y-4 text-gray-700">
              <p><strong>1. Sign Up:</strong> Fill out our simple Contact Us form to join the program.</p>
              <p><strong>2. Share:</strong> Use your unique affiliate link to promote our products on your blog, social media, or website.</p>
              <p><strong>3. Earn:</strong> Receive a commission for every purchase made through your affiliate link.</p>
            </div>
          </section>
          ...
          <section className="text-center bg-white/80 p-8 rounded-xl shadow-lg backdrop-blur-sm">
            ...
            {/* UPDATED LINK HERE: Points to /contact instead of /register */}
            <Link to="/contact" className="inline-block bg-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
              Apply Now
            </Link>
          </section>
        </div>

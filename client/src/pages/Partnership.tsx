        ...
        <div className="max-w-4xl mx-auto">
          ...
          <section className="text-center bg-white/80 p-8 rounded-xl shadow-lg backdrop-blur-sm">
            ...
            <p className="text-gray-700">
              To discuss a potential partnership, please reach out to our collaborations team at{" "}
              <a 
                href="mailto:partners@hansithacreations.com" 
                className="text-purple-700 font-bold hover:underline hover:text-purple-900 transition-colors"
              >
                partners@hansithacreations.com
              </a>{" "}
              with your proposal.
            </p>
          </section>

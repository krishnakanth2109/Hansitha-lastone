  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 text-gray-800">
      ...
      <ul className="list-disc list-inside space-y-1">
        ...
        <li>Contact Form: <a href="https://hansitha-creations.netlify.app/contact" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">https://hansithacreations.netlify.app/contact</a></li>
      </ul>
    </div>
  );
};

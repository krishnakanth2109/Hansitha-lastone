...
import { Package, Truck, CheckCircle, Loader2, XCircle } from "lucide-react";
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      ...
      try {
        ...
        // ✅ FIXED: Only show orders where payment actually succeeded.
        // This prevents failed/abandoned Razorpay sessions from showing as "Placed".
